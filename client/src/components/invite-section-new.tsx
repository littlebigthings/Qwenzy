...
import { Loader2, ChevronLeft, ChevronRight, X, Link as LinkIcon } from "lucide-react";
...
export function InviteSection({
  ...
  const copyInvitationLink = () => {
    ...
    const deploymentUrl = window.location.hostname.endsWith(".replit.app")
      ? window.location.origin
      : "http://localhost:3000";
    
    const inviteUrl = `${deploymentUrl}/register?invitation=true&organization=${organization.id}`;
